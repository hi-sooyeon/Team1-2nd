...
<%  
	...
	*/
	...
	try{
		conn = DriverManager.getConnection("jdbc:oracle:thin:@localhost:49161:XE","bituser","1004");
		...
		if(result !=0){
			out.print("<script>");
				out.print("location.href='Ex02_JDBC_Btrap_Login.jsp'");	
			out.print("</script>");
		}else{ //실행될 확률 거의없다 ...
			out.print("<script>");
		...
		out.print("<script>");
			out.print("alert('가입실패');");	
			out.print("location.href='Ex02_JDBC_Btrap_JoinForm.jsp'");	
		out.print("</script>");
	}finally{
